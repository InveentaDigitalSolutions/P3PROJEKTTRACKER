...
ACT={'NOT_STARTED':100000000,'IN_PROGRESS':100000001,'BLOCKED':100000002,'CLOSED':100000003}
RYG_GREEN=100000002
...
def state_for(status):
    ...
    return 'NOT_STARTED'   # plan, n/a, blank
...
def main():
    ...
    for idx,p in enumerate(projects):
        ...
        for t in p['tasks']:
            ...
            start=t['start'] or pstart
            end=t['finish'] or start
            ab={
